...
//calling constructor for headphone class
headPhones::headPhones(std::string Name, int serialNumber) : Name(Name), serialNumber(serialNumber), color("black"), type("wired") {}

void headPhones::printInformation(){
	std::cout << "This is a: " << Name << std::endl;
	std::cout << "Serial Number is: " << serialNumber << std::endl;
	}
...
void headPhones::getColor() const {
    /*
    5. Encapsulation exercise getter and setter
    5a. create getter and setter methods for serialNumber to enforce encapsulation
    */

    std::cout << "headphone color is: " << color << std::endl;

}

void headPhones::setColor(std::string headphoneColor){
    /*
    5. Encapsulation exercise getter and setter
    5a. create getter and setter methods for serialNumber to enforce encapsulation
    */
...
void headPhones::getSerialNumber() const{
    /*
    5. Encapsulation exercise getter and setter
    5a. create getter and setter methods for serialNumber to enforce encapsulation
    */
...
void headPhones::setSerialNumber(int userSerialNumber){
    /*
    5. Encapsulation exercise getter and setter
    5a. create getter and setter methods for serialNumber to enforce encapsulation
    */
...
void headPhones::getType() const{
    /*
    5. Encapsulation exercise getter and setter
    5a. create getter and setter methods for serialNumber to enforce encapsulation
    */
    std::cout << "Headphone type is: " << type << std::endl;

}

void headPhones::setType(std::string newType){
    /*
    5. Encapsulation exercise getter and setter
    5a. create getter and setter methods for serialNumber to enforce encapsulation
    */
...
void printPhones(std::vector<Phone>& phoneVect){
    ...
    for(i = 0; i < phoneVect.size(); i++){
        //Print phones
        phoneVect.at(i).printInformation();
    }
}